...
values
  (
    'cobudget',
    'https://www.cobudget.com/',
    'Cobudget',
    '{ "en": "Cobudget is an open source platform for collaborative budgeting and decision-making. It allows communities to allocate funds collectively and transparently.", "fr": "Cobudget est une plateforme open source pour la budgétisation collaborative et la prise de décision. Elle permet aux communautés d''allouer des fonds de manière collective et transparente." }'
  ),
  (
    'pretix',
    'https://pretix.eu/',
  ...
  (
    'fai-volunteer',
    'https://github.com/Flashpoint-Artists-Initiative/Volunteering',
    'FAI Volunteering System',
    '{
